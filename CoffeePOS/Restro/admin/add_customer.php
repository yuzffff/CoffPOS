...
//ในส่วนของการเพิ่มข้อมูลลูกค้า หลังจากที่ตรวจสอบการเข้าสู่ระบบแล้ว codeจะตรวจสอบว่ามีการส่งค่าผ่าน POST มาหรือไม่ และตรวจสอบว่าค่าที่ส่งมาว่างเปล่าไหม
//หากไม่ว่างเปล่าจะดึงค่าจากฟอร์มและเพิ่มข้อมูลลูกค้าลงในDatabase MySQL โดยใช้คำสั่ง SQL INSERT INTO
//หลังจากเพิ่มข้อมูลลูกค้าลงในDatabaseสำเร็จ จะมีการแสดงข้อความ "Customer Added" และ redirect Userกลับไปยังหน้า customes.php 
