...
//ในส่วนของการเพิ่มข้อมูลสินค้า หลังจากที่ตรวจสอบการเข้าสู่ระบบแล้ว codeจะตรวจสอบว่ามีการส่งค่าผ่าน POST มาหรือไม่ และตรวจสอบว่าค่าที่ส่งมาว่างเปล่าไหม
//หากไม่ว่างเปล่าจะดึงค่าจากฟอร์มและเพิ่มข้อมูลสินค้าลงในDatabase MySQL โดยใช้คำสั่ง SQL INSERT INTO
//หลังจากเพิ่มข้อมูลสินค้าลงในDatabaseสำเร็จ จะมีการแสดงข้อความ "Add Product" และ redirect Userกลับไปยังหน้า customes.php 
//โดยใช้ header("refresh:1; url=products.php") เพื่อให้Userเห็นข้อความดังกล่าวเป็นเวลาหนึ่งวินาทีก่อนที่จะไปยังหน้าถัดไป
