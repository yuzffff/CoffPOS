...
//Codeทำการตรวจสอบค่าที่ได้รับจากแบบฟอร์มการชำระเงิน เช่น pay_code, pay_amt, และ pay_method เพื่อเช็คว่าไม่มีค่าใดๆ เป็นค่าว่าง
//หากไม่มีค่าว่าง Codeจะทำการเก็บข้อมูลการชำระเงินลงในตาราง rpos_payments โดยใช้คำสั่ง SQL INSERT
//อัปเดตสถานะของคำสั่งซื้อในตาราง rpos_orders เป็น "Paid" เพื่อระบุว่าคำสั่งซื้อได้รับการชำระเงินแล้ว
//หากเก็บข้อมูลและการอัปเดตสถานะเสร็จสมบูรณ์ จะแสดงข้อความ "Paid" และเรียกใช้งานหน้า receipts.php เพื่อแสดงหน้าใบเสร็จ
//หากมีข้อผิดพลาดเกิดขึ้นในขณะทำงาน จะแสดงข้อความแจ้งเตือนว่า "Please Try Again Or Try Later" เพื่อแจ้งให้ผู้ใช้ทราบว่ามีปัญหาเกิดขึ้น
