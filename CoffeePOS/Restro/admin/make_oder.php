          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <?php } ?>
                <!--ใช้สำหรับดึงข้อมูลของสินค้าจากDatabaseและแสดงในฟอร์ม HTML เพื่อให้Userสามารถดูรายละเอียดของสินค้าและเลือกจำนวนสินค้าที่ต้องการซื้อ-->
                <!--รับค่า prod_id ที่ถูกส่งมาผ่าน URL โดยใช้ $_GET['prod_id'] เพื่อใช้ในการดึงข้อมูลสินค้าจากDatabase-->
                <!--สร้างคำสั่ง SQL SELECT เพื่อดึงข้อมูลของสินค้าที่ตรงกับ prod_id ที่ได้รับมา จากนั้นจะ execute คำสั่ง SQL และเก็บผลลัพธ์ไว้ในตัวแปร $res-->
                <!--Codeวนลูปผ่านผลลัพธ์ที่ได้รับจากการ execute เพื่อแสดงข้อมูลของสินค้าที่ดึงมา ในรูปแบบของฟอร์ม HTML ซึ่งประกอบไปด้วย input fields สำหรับราคาสินค้าและจำนวนสินค้าที่ต้องการซื้อ-->
                <!--ในฟิลด์ input สำหรับจำนวนสินค้า (prod_qty) จะไม่มีค่าเริ่มต้นที่กำหนด ซึ่งUserสามารถใส่ค่าจำนวนสินค้าที่ต้องการได้เอง แต่สำหรับฟิลด์ input สำหรับราคาสินค้า (prod_price) จะถูกกำหนดให้เป็น readonly โดยมีค่าเริ่มต้นเป็นราคาของสินค้าที่ได้รับมาจากDatabase-->
                <br>
                <div class="form-row">
                  <div class="col-md-6">
